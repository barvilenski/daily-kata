/* Name: Bouncing Balls
 * Level: 6kyu
 * Instructions: A child is playing with a ball on the nth floor of a tall building.
 ...
 *
 * Note: The ball can only be seen if the height of the rebounding ball is stricty greater
...
function bouncingBall(height,  bounce,  window) {
  let counter = -1;
  if (height > 0 && height > window && bounce > 0 && bounce < 1) {
    do {
      counter += 2;
