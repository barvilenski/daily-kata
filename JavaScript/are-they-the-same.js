 ...
 * Level: 6kyu
 * Instructions: Given two arrays a and b write a function comp(a, b)
 * (compSame(a, b) in Clojure) that checks whether the two arrays have the "same"
 * elements, with the same multiplicities. "Same" means, here, that the elements
...
function comp(array1, array2) {
  ...
  array1.sort((a,b) => a - b);
  array2.sort((a,b) => a - b);
  return array1.every((num, idx) => num * num === array2[idx]);
}
