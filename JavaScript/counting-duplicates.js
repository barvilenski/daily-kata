 ...
 * Level: 6kyu
 * Description: Count the number of Duplicates. Write a function that will
 ...
 * Examples: "abcde" -> 0 # no characters repeats more than once
 * "aabbcde" -> 2 # 'a' and 'b'
...
function duplicateCount(text) {
  ...
  text.forEach((char) => chars[char] = chars[char] ? chars[char] + 1 : 1);
  Object.values(chars).forEach((val) => count += val >= 2 ? 1 : 0);
