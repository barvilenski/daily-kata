 ...
 * Level: 7kyu
 * Instructions: In this Kata, your function receives an array of integers as input.
 ...
 * considered a degenerate case and therefore will not be tested in this Kata - feel free
 * to raise an Issue if you see such a list being tested.
 *
 * For example:
...
const inAscOrder = arr => arr.every((_, idx) => idx === 0 || arr[idx - 1] <= arr[idx]);
