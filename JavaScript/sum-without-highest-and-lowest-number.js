 ...
 * Level: 8kyu
 * Instructions: Sum all the numbers of the array (in F# and Haskell you get a list)
...
const sumArray = array => array ? array.sort((a,b) => a-b).slice(1,-1).reduce((sum, cur) => sum+cur, 0) : 0;
