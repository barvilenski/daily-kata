 ...
 * Level: 7kyu
 * Instructions: Given a string and an array of index numbers, return the
 * characters of the string rearranged to be in the order specified by the accompanying array.
 * 
 * Ex:
...
const scramble = (str, arr) => [...Array(arr.length)].map((_, prevIdx) => str.charAt(arr.indexOf(prevIdx))).join('');
