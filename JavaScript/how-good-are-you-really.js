 ...
 *
 * Note:
 * Your points are not included in the array of your classes points. For calculating the
 * average point you may add your point to the given array!
 */

const betterThanAverage = (classGrades, yourGrade) => yourGrade > [...classGrades, yourGrade].reduce((sum, grade) => sum + grade, 0) / (classGrades.length + 1);
