...
Name: Double Cola
Level: 5kyu
Instructions: Sheldon, Leonard, Penny, Rajesh and Howard are in the queue for a
...
The resulting two Sheldons go to the end of the queue. Then the next in the queue
