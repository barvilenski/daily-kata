...
Name: Integer depth
Level: 6kyu
Description: The depth of an integer n is defined to be how many multiples of n
...
integer argument.Only positive numbers greater than zero will be passed as an input.
"""
