...
Name: Best travel
Level: 5kyu
Instructions: John and Mary want to travel between a few towns A, B, C ...
...
k (number of towns to visit, k >= 1) and ls (list of distances, all distances are
positive or null integers and this list has at least one element).
